...
void UEnemyProjectileComponent::SpawnProjectile(FName ComponentName, TSubclassOf<AActor> ProjectileClass)
{
	...
	FRotator ProjectileRotation = UKismetMathLibrary::FindLookAtRotation(SpawnLocation, PlayerLocation);

	GetWorld()->SpawnActor(ProjectileClass, &SpawnLocation, &ProjectileRotation);
}
